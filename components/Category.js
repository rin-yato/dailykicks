        ...
        <div className="flex flex-col mt-3">
          ...
          <div className="brand-container grid grid-cols-2 auto-rows-fr px-4 gap-4">
            {brands.map((brand) => (
              ...
              >
                <img src={brand.image} alt={brand.name} className="z-[20]" />
              </ButtonBase>
            ))}
          </div>
        </div>
        <div className="mt-4 py-3 px-4 pb-16">
          ...
          <div className="accessories-container">
            <ButtonBase className="h-[127px] overflow-hidden flex rounded-md shadow-md">
              <img src="/logos/socks.jpeg" alt="" className="h-full" />
              <img src="/logos/socks3.jpeg" alt="" className="h-full" />
              <img src="/logos/socks1.jpeg" alt="" className="h-full" />
